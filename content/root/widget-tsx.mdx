---
title: Widget.tsx
description: The generic widget component that powers all widgets in Wigggle.
date: 2025-01-01
published: true
---
...
<Callout className="mt-6">
	Note: If you are using shadcn-ui, you can skip to <span className="text-green-500">Step 8</span>.
</Callout>
...
Here's what [ShadCN's](https://ui.shadcn.com/docs/installation/manual) <span className="text-yellow-400 font-mono">tsconfig.json</span> file looks like:
